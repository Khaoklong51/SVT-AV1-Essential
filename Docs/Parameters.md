...
| **CRF**                          | --crf                            | [1-63]     | 30          | Constant Rate Factor value, setting this value is equal to `--rc 0 --aq-mode 2 --qp x`                                                               |
...
| **VarianceOctile**               | --variance-octile                | [1-8]      | 4           | Set variance algorithm 8x8 block selectivity level [1: 1st octile, 4: median [Default], 5: 5th octile, 8: maximum]                                   |
...
| **AltCDEF**                      | --enable-alt-cdef                | [0-1]      | 0           | Enable alternative CDEF bias (experimental), which comes with new SAD & SATD based distortion calculation and various other improvements.            |
...
| **Configuration file parameter** | **Command line**      | **Range**       | **Default**       | **Description**                                                                                                                                              |
|----------------------------------|-----------------------|-----------------|-------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Keyint**                       | --keyint              | [-1-`(2^31)-1`] | -1                | Max GOP size (frames), use `s` suffix for seconds (SvtAv1EncApp only) [-1: ~5 seconds, 0: "infinite" only for CRF]                                           |
